...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        bool UnshareNavMeshAsset()
        {
            ...
            var prefabInstanceType = UnityEditor.PrefabUtility.GetPrefabInstanceStatus(this);
            if (prefabAssetType == UnityEditor.PrefabAssetType.Regular && prefabInstanceType == PrefabInstanceStatus.Connected)
                return false;
